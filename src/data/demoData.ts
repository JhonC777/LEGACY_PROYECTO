...
export const DEMO_PROJECTS: DemoProject[] = [
  {
    ...
    description:
      'El proyecto consiste en un emprendimiento y propuesta artístico-educativa llamada Wildanger Art. Se enfoca en la elaboración y comercialización de cuadros artísticos en alto relieve hechos a mano, inspirados en especies de animales en peligro de extinción en Colombia. Cada cuadro incorpora un código QR que dirige al usuario a plataformas/redes sociales donde se proporciona información sobre la especie representada, promoviendo la conservación ambiental y embelleciendo espacios físicos.',
    problem:
      'El impacto negativo de las actividades humanas sobre el medio ambiente y la biodiversidad ha generado un alarmante ritmo de extinción de especies. En Colombia, una gran cantidad de especies de fauna silvestre están clasificadas en alguna categoría de amenaza debido a la destrucción de hábitats, la contaminación y la falta de conciencia ambiental en la sociedad.',
    solution:
      'Crear una propuesta que fusione el arte, la tecnología y la educación ambiental. A través de obras plásticas en alto relieve se busca generar una conexión emocional con el espectador, mientras que el código QR y la difusión en medios digitales brindan acceso inmediato a información educativa sobre el estado de la fauna y acciones para su protección.',
    methodology:
      'La metodología consistió en una investigación bibliográfica sobre la conservación de fauna y proyectos ambientales en Colombia, complementada con un estudio de mercado mediante encuestas a habitantes de Barranquilla para validar la intención de compra (82,2%) y definir las características del producto. Posteriormente, se estableció un proceso de producción artesanal que abarca desde el boceto hasta el modelado del relieve mediante una mezcla de yeso, pegamento y pintura, hasta el sellado y completo de la obra. Finalmente, se integró un código QR con contenido educativo y se estructuró la comercialización mediante redes sociales, con entregas a domicilio.',
    results:
      'Los resultados mostraron una alta aceptación en el mercado con un 82,2% de intención de compra en Barranquilla, identificando una preferencia por cuadros de tamaño mediano y tonos cálidos. En el aspecto económico, se determinó un costo unitario de producción de $64.691 COP y un precio de venta de $90.567 COP con una proyección de ventas de 159 unidades durante el primer año. Finalmente, se logró la elaboración exitosa de las obras de arte en alto relieve, códigos QR funcionales y la definición de un plan de manejo ambiental para mitigar el impacto de los materiales de fabricación.',
    technologies: ['QR'],
    tags: ['animales en vía de extinción', 'cuadros', 'pintura', 'alto relieve'],
    coverImage: '/covers/cuadros-relieve-tortuga.jpg',
    gallery: ['/covers/cuadros-relieve-tortuga.jpg'],
    docUrl:
      '/resources/proyecto-de-grado-lectura-critica.docx#Proyecto%20de%20Grado%20(Lectura%20Cr%C3%ADtica).docx',
    isFeatured: true,
    isReal: true,
    status: 'published',
  },
